...
- Never put invitations or records in URLs, logs, UserDefaults, fixtures, screenshots, telemetry or source. Display discoverable verification codes for comparison only. If using manual invitations, transfer their secret codes directly through protected app input. Record stable errors and synthetic observations instead of credential data.
